...
type Report interface {
	...
	Report(log *xlog.Logger, cfg *config.Linter, lintResults map[string][]LinterOutput)
}
...
func (l *LocalRunner) re(ctx context.Context, cfg *config.Linter) (io.ReadCloser, error) {
